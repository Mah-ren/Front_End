...
//! concatination +
//! old way (today is 3 march the first day of ramadan 3:23 am and wanted to make the firb character with css and the moonlight with css and wanted to do what i've learnt)
...
//! calculation  (today is 3 march the first day of ramadan 3:23 am and wanted to make the firb character with css and the moonlight with css and wanted to do what i've learnt)
...
//!! converting the text to number 
//! converting the text to number (today is 3 march the first day of ramadan 3:23 am and wanted to make the firb character with css and the moonlight with css and wanted to do what i've learnt)
...
//! other ways to convert the '59' to 59 (today is 3 march the first day of ramadan 3:23 am and wanted to make the firb character with css and the moonlight with css and wanted to do what i've learnt)
...
//!! slice(start, end) and the value can be negative, you subtract the end from the start to get the lenegth of the word that you wanna cut
//!! substring(start, end) the value can't be negative
//!! substr(start, length) 
...
let names$ = ['Renad', 'Mahmoud', 'Safia', 'Hna'];

//! to reverse the array use array_name.reverse()
console.log('this is the array before reverse');
console.log(names$);

console.log('this is the array after reverse');
console.log(names$.reverse());

console.log('this is the array after sort');
console.log(names$.sort());


let numbers = [9, 8, 6, 2, 7, 5, 3, 1, 4];
console.log("this is the array before sort ");
console.log(numbers);
...
let arr1 = ['Mahmoud', 'Ahmed', 'Abdel aal'];
let arr2 = ['Renad', 'Saleh', 'Afefe'];
console.log(arr1 + arr2);

//! by this way you get a string not an array
console.log(typeof(arr1 + arr2));

//! but if you wanna get an array 
let arr3 = arr1.concat(arr2);
console.log(arr3);

// ! and you can concatenate an element with the array
console.log(arr1.concat(arr2,'Mohsen'));

//! but last code for printing, i didn't store the value in the array
console.log(arr1)

// ! and you can concatenate an element with the array
console.log(arr3.concat('Mohsen'));

//! you can convert the array to string -> .join()
console.log(arr3.join());
console.log(typeof(arr3.join()));
//! you can write the delemiter between the braces of the join('delimiter');
console.log(arr3.join('#//#'));

let Renad = '         Renad     ';
console.log(Renad.trim().toUpperCase());
console.log(Renad.trim().length);