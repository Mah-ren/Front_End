...
//! change the color of the placeholder to white
...
//! add an item (add it in array + show it in outputs + clear inputs data so i can write another item without clearing inputs data each time i create an item
//! + store itmes in localStorage)
